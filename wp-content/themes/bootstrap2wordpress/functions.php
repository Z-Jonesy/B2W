<?php
/**
 * Bootstratp to Wordpress functions and definitions
 *
...
if ( ! function_exists( 'bootstrap2wordpress_setup' ) ) :
	...
	function bootstrap2wordpress_setup() {
		 ...
		 * If you're building a theme based on Bootstratp to Wordpress, use a find and replace
...
function bootstrap2wordpress_scripts() {
	...
	wp_enqueue_script( 'bootstrap2wordpress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
