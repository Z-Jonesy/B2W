            ...
            <main id="content" class="col-sm-8">
                <div class="error-404 not-found">
                    <div class="page-content">
                        <h2>Don't fret ! Let' get you back on track.</h2>
                        <h3>Resources</h3>
                        <p>Perhaps you were looking for specific resource?</p>
                        ...
                        <?php
                            the_widget('WP_Widget_Archives','title= Our Archives','before_title=<h4 class="widgettitle">&after_title=</h4>');
                        ?>
